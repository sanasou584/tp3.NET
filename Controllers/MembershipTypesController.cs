...
namespace Tp3EFcoreRelations.Controllers
{
    public class MembershipTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,SingUpFree,DurationInMonth,DiscountRate")] MembershipType membershipType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,SingUpFree,DurationInMonth,DiscountRate")] MembershipType membershipType)
        {
